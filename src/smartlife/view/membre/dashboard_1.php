                                ...
                                <div class="row block">
                                   <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="recent-activity futureServiceHide">
                                            <br>
                                            <ul> <!--https://smarts-life.com/bitchange/?page=buybitcoin -->
                                                <li>
												...
												<?php endif;?>
                                                        <h2 class="box-title">
                                                            <span class="glyphicon glyphicon-bitcoin"></span>   Echange de Bitcoin
                                                        </h2>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="recent-activity futureServiceHide">
                                            <ul> <!--https://smarts-life.com/bitchange/?page=buybitcoin -->
                                                <li>
                                                    <a href="#">
                                                        <h2 class="box-title">
                                                           <span class="glyphicon glyphicon-apple"></span>   E-market
                                                        </h2>
														<span class="spanServ">Service en cours de réalisation...</span>
                                                    </a>
                                        ...
                                        <div class="recent-activity futureServiceHide">
                                            <ul> 
                                                <li>
                                                    <a href="#">
                                                        <h2 class="box-title">
                                                           <span class="fa fa-money"></span>   Crow funding
                                                        </h2>
														<span class="spanServ">Service en cours de réalisation...</span>
                                                    </a>
                                        ...
                                        <div class="recent-activity futureServiceHide">
                                            <ul> 
                                                <li>
                                                    <a href="#">
                                                        <h2 class="box-title">
                                                           <span class="fa fa-car"></span>   Transport Terrestre et Aérien
                                                        </h2>
														<span class="spanServ">Service en cours de réalisation...</span>
                                                    </a>
                                        ...
                                        <div class="recent-activity futureServiceHide">
                                            <ul> 
                                                <li>
                                                    <a href="#">
                                                        <h2 class="box-title">
                                                           <span class="fa fa-hotel"></span>   Hotelerie
                                                        </h2>
														<span class="spanServ">Service en cours de réalisation...</span>
                                                    </a>
                                        ...
                                        <a href="<?php echo Router::url('histocash'); ?>">
                                            <div class="fact blue">
                                                <div class="numbers counters-box">
                                                    ...
                                                    <dl>
                                                        <dd style="font-size: 30px;">Hotelerie</dd>
                                                    </dl>
